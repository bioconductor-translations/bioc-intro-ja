---
source: Rmd
title: Organização de dados com planilhas
teaching: 30
exercises: 30
---
...
- Como formatamos os dados em planilhas para um uso eficaz de dados?
- Aprenda sobre erros comuns da manipulação de planilhas e como corrigi-los.
- - Organize os seus dados de acordo com os princípios _tidy_.
- Saiba mais sobre os formatos de folhas de cálculo baseados em texto, como os formatos separados por vírgula (CSV) ou separados por tabulações (TSV).
