...
<img src="fig/spreadsheet-setup-updated.png" alt="スプレッドシートとREADME.txtファイルのスクリーンショット" width="70%" />
<p class="caption">スプレッドシート設定例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/multiple-info.png" alt="一つの列にABO型とRh因子が混在して記録された表" width="70%" />
<p class="caption">単一列に複数の変数を混在させた例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/single-info.png" alt="ABO型とRh因子がそれぞれ別の列に記録された表" width="70%" />
<p class="caption">各変数を別々の列に配置した例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/2_datasheet_example.jpg" alt="サブテーブルが多数存在するシートの例" width="70%" />
<p class="caption">サブテーブルが多数存在するシートの例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/3_white_table_1.jpg" alt="論文から抜粋した、一般的に使用されているnull値を示す表" width="70%" />
<p class="caption">一般的に使用されているnull値の例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/formatting.png" alt="サンプル汚染を示すために黄色で強調表示された複数のセルを示す表" width="70%" />
<p class="caption">情報符号化に使用される色の例</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/good_formatting.png" alt="上記と同じ表に、汚染を示す新しい変数を追加したもの" width="70%" />
<p class="caption">サンプル汚染を符号化する新しい変数</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/excel-to-csv.png" alt="MacOSでExcelデータをCSV形式でエクスポートするメニュー" width="70%" />
<p class="caption">ExcelファイルをCSV形式で保存する方法</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/csv-mistake.png" alt="セル内にカンマが含まれるために正しくインポートされなかったデータの例。該当セルは2つのセルに分割されている" width="80%" />
<p class="caption">カンマを含む区切りデータを読み込む際の問題点</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="fig/analysis.png" alt="データ変換・可視化・モデリングを繰り返すデータ分析のサイクル。tidyデータ分析の概念図" width="70%" />
<p class="caption">典型的なデータ分析ワークフロー</p>
</div>
